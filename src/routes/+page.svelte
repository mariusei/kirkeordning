...
<p class="pb-2">
        For detaljer, avklaringer og presiseringer <a class="underline underline-offset-8" href="https://lovdata.no/dokument/NL/lov/2020-04-24-31">se lovteksten i sin helhet</a>.
</p>
<p class="pb-2">
    Den norske kirke er kun lovpålagt å ha to organer: Kirkemøtet og menighetsrådene. De andre organene vi kjenner i dag (kirkeråd, fellesråd, og bispedømmeråd) er ikke lovpålagte, selv om du finner forskrifter og regler for disse. Bestemmelsene om disse andre organene styres helt av Kirkemøtet alene.
</p>
<p class="pb-2">
    Fra organisasjons- og næringslivet kan Kirkemøtet og menighetsrådene sammenliknes med rettssubjektenes <em>styrer</em>.
</p>
...
<h2 class="text-xl pt-4">
    ...
    <p>
        ...
        <ol class="list-decimal px-8 pb-2">
            <li>Alle er ansatt i soknet lokalt.</li>
            <li>Alle er ansatt i Den norske kirke nasjonalt.</li>
